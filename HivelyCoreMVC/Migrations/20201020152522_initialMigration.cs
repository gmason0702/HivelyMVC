    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HiveListItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HiveListItem_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HiveListItem_Queens_QueenId",
                        column: x => x.QueenId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiveRating = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HiveListItem_LocationId",
                table: "HiveListItem",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_HiveListItem_QueenId",
                table: "HiveListItem",
                column: "QueenId");
